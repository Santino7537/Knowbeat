...
const USER_PERMISSIONS = ['user-get-user', 'user-get-users', 'user-get-config', 'user-update-config', 'user-update-profile', 'user-create-folder', 'user-update-folder', 'user-delete-folder', 'user-get-folder-files', 'course-get-courses', 'user-get-progress', 'user-register-course', 'user-get-stats', 'user-update-goal'];
