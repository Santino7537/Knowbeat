...
const USER_PERMISSIONS = ['user-get-user', 'user-get-user-username', 'user-get-users', 'user-get-config', 'user-update-config', 'user-update-profile', 'course-get-courses', 'user-get-progress', 'user-register-course'];
